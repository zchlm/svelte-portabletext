...
export declare type PortableTextMarkType = 'strong' | 'em' | 'strike-through' | 'underline' | 'code' | string;
export type InputValue = PortableTextBlock | ArbitraryTypedObject | (PortableTextBlock | ArbitraryTypedObject)[];
